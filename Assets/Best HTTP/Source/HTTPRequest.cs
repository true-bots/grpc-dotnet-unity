				...
				switch (Proxy.Credentials.Type)
				{
					case AuthenticationTypes.Basic:
						...
						SetHeader("Proxy-Authorization",
							string.Concat("Basic ", Convert.ToBase64String(Encoding.UTF8.GetBytes(Proxy.Credentials.UserName + ":" + Proxy.Credentials.Password))));
						break;
				...
				switch (Credentials.Type)
				{
					case AuthenticationTypes.Basic:
						...
						SetHeader("Authorization",
							string.Concat("Basic ", Convert.ToBase64String(Encoding.UTF8.GetBytes(Credentials.UserName + ":" + Credentials.Password))));
						break;
