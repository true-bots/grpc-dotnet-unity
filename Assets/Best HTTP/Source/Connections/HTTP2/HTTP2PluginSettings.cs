...
namespace BestHTTP.Connections.HTTP2
{
	...
	public sealed class HTTP2PluginSettings
	{
		...
		/// </summary>
		public uint HeaderTableSize = 4096; // Spec default: 4096

		/// <summary>
		/// Maximum concurrent http2 stream on http2 connection will allow. Its default value is 128;
		/// </summary>
		public uint MaxConcurrentStreams = 128; // Spec default: not defined

		/// <summary>
		/// Initial window size of a http2 stream. Its default value is 10 Mb (10 * 1024 * 1024).
		/// </summary>
		public uint InitialStreamWindowSize = 10 * 1024 * 1024; // Spec default: 65535

		/// <summary>
		/// Global window size of a http/2 connection. Its default value is the maximum possible value on 31 bits.
		/// </summary>
		public uint InitialConnectionWindowSize = HTTP2Handler.MaxValueFor31Bits; // Spec default: 65535

		/// <summary>
		/// Maximum size of a http2 frame.
		/// </summary>
		public uint MaxFrameSize = 16384; // 16384 spec def.

		/// <summary>
		/// Not used.
		/// </summary>
		public uint MaxHeaderListSize = uint.MaxValue; // Spec default: infinite
