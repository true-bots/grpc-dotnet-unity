...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Custom.Sec
{
		...
		: AbstractFpPoint
	{
		...
		public override ECPoint Add(ECPoint b)
		{
			...
			SecP224K1FieldElement X1 = (SecP224K1FieldElement)RawXCoord, Y1 = (SecP224K1FieldElement)RawYCoord;
			SecP224K1FieldElement X2 = (SecP224K1FieldElement)b.RawXCoord, Y2 = (SecP224K1FieldElement)b.RawYCoord;

			SecP224K1FieldElement Z1 = (SecP224K1FieldElement)RawZCoords[0];
		...
		public override ECPoint Twice()
		{
			...
			SecP224K1FieldElement Y1 = (SecP224K1FieldElement)RawYCoord;
			if (Y1.IsZero)
			{
				return curve.Infinity;
			}

			SecP224K1FieldElement X1 = (SecP224K1FieldElement)RawXCoord, Z1 = (SecP224K1FieldElement)RawZCoords[0];
