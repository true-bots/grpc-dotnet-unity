...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Custom.Sec
{
	class SecT163R2Curve
		: AbstractF2mCurve
	{
		const int SECT163R2_DEFAULT_COORDS = COORD_LAMBDA_PROJECTIVE;
		const int SECT163R2_FE_LONGS = 3;
		static readonly ECFieldElement[] SECT163R2_AFFINE_ZS = new ECFieldElement[] { new SecT163FieldElement(BigInteger.One) };
			...
			: base(163, 3, 6, 7)
		{
			...
			m_coord = SECT163R2_DEFAULT_COORDS;
		}
		...
		{
			readonly SecT163R2Curve m_outer;
