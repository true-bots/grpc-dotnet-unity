...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Custom.Sec
{
		...
		: AbstractFpCurve
	{
		...
		const int SECP192K1_DEFAULT_COORDS = COORD_JACOBIAN;
		const int SECP192K1_FE_INTS = 6;
		static readonly ECFieldElement[] SECP192K1_AFFINE_ZS = new ECFieldElement[] { new SecP192K1FieldElement(BigInteger.One) };
		...
		{
			readonly SecP192K1Curve m_outer;
