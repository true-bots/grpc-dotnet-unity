...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Custom.Sec
{
	class SecT233R1Curve
		: AbstractF2mCurve
	{
		const int SECT233R1_DEFAULT_COORDS = COORD_LAMBDA_PROJECTIVE;
		const int SECT233R1_FE_LONGS = 4;
		static readonly ECFieldElement[] SECT233R1_AFFINE_ZS = new ECFieldElement[] { new SecT233FieldElement(BigInteger.One) };
			...
			: base(233, 74, 0, 0)
		{
			...
			m_coord = SECT233R1_DEFAULT_COORDS;
		}
		...
		class SecT233R1LookupTable
			: AbstractECLookupTable
		{
			readonly SecT233R1Curve m_outer;
