...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Custom.Sec
{
		...
		: AbstractFpPoint
	{
		...
		public override ECPoint Add(ECPoint b)
		{
			...
			SecP160R1FieldElement X1 = (SecP160R1FieldElement)RawXCoord, Y1 = (SecP160R1FieldElement)RawYCoord;
			SecP160R1FieldElement X2 = (SecP160R1FieldElement)b.RawXCoord, Y2 = (SecP160R1FieldElement)b.RawYCoord;

			SecP160R1FieldElement Z1 = (SecP160R1FieldElement)RawZCoords[0];
		...
		public override ECPoint Twice()
		{
			...
			SecP160R1FieldElement Y1 = (SecP160R1FieldElement)RawYCoord;
			if (Y1.IsZero)
			{
				return curve.Infinity;
			}

			SecP160R1FieldElement X1 = (SecP160R1FieldElement)RawXCoord, Z1 = (SecP160R1FieldElement)RawZCoords[0];
