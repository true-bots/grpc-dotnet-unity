...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Math.EC.Custom.Sec
{
		...
		: AbstractFpPoint
	{
		...
		public override ECPoint Add(ECPoint b)
		{
			...
			SecP128R1FieldElement X1 = (SecP128R1FieldElement)RawXCoord, Y1 = (SecP128R1FieldElement)RawYCoord;
			SecP128R1FieldElement X2 = (SecP128R1FieldElement)b.RawXCoord, Y2 = (SecP128R1FieldElement)b.RawYCoord;

			SecP128R1FieldElement Z1 = (SecP128R1FieldElement)RawZCoords[0];
		...
		public override ECPoint Twice()
		{
			...
			SecP128R1FieldElement Y1 = (SecP128R1FieldElement)RawYCoord;
			if (Y1.IsZero)
			{
				return curve.Infinity;
			}

			SecP128R1FieldElement X1 = (SecP128R1FieldElement)RawXCoord, Z1 = (SecP128R1FieldElement)RawZCoords[0];
