...
{
	abstract class Ssl3Utilities
	{
		static readonly byte[] SSL_CLIENT = { 0x43, 0x4C, 0x4E, 0x54 };
		static readonly byte[] SSL_SERVER = { 0x53, 0x52, 0x56, 0x52 };
		...
		static void CompleteHash(byte[] master_secret, TlsHash hash, int padLength)
		{
