		...
		*/
        ...
        private void DecryptBlock(ReadOnlySpan<byte> input, Span<byte> output, uint[][] KW)
        {
            ...
            while (r > 1)
            {
                kw = KW[r--];
                r0 =
 Inv_Mcol((uint)Si[t0 & 255] ^ (((uint)Si[(r3 >> 8) & 255]) << 8) ^ (((uint)Si[(t2 >> 16) & 255]) << 16) ^ ((uint)Si[(t1 >> 24) & 255] << 24)) ^ kw[0];
                r1 =
 Inv_Mcol((uint)Si[t1 & 255] ^ (((uint)Si[(t0 >> 8) & 255]) << 8) ^ (((uint)Si[(r3 >> 16) & 255]) << 16) ^ ((uint)Si[(t2 >> 24) & 255] << 24)) ^ kw[1];
                r2 =
 Inv_Mcol((uint)Si[t2 & 255] ^ (((uint)Si[(t1 >> 8) & 255]) << 8) ^ (((uint)Si[(t0 >> 16) & 255]) << 16) ^ ((uint)Si[(r3 >> 24) & 255] << 24)) ^ kw[2];
                r3 =
 Inv_Mcol((uint)Si[r3 & 255] ^ (((uint)Si[(t2 >> 8) & 255]) << 8) ^ (((uint)Si[(t1 >> 16) & 255]) << 16) ^ ((uint)Si[(t0 >> 24) & 255] << 24)) ^ kw[3];
                kw = KW[r--];
                t0 =
 Inv_Mcol((uint)Si[r0 & 255] ^ (((uint)Si[(r3 >> 8) & 255]) << 8) ^ (((uint)Si[(r2 >> 16) & 255]) << 16) ^ ((uint)Si[(r1 >> 24) & 255] << 24)) ^ kw[0];
                t1 =
 Inv_Mcol((uint)Si[r1 & 255] ^ (((uint)Si[(r0 >> 8) & 255]) << 8) ^ (((uint)Si[(r3 >> 16) & 255]) << 16) ^ ((uint)Si[(r2 >> 24) & 255] << 24)) ^ kw[1];
                t2 =
 Inv_Mcol((uint)Si[r2 & 255] ^ (((uint)Si[(r1 >> 8) & 255]) << 8) ^ (((uint)Si[(r0 >> 16) & 255]) << 16) ^ ((uint)Si[(r3 >> 24) & 255] << 24)) ^ kw[2];
                r3 =
 Inv_Mcol((uint)Si[r3 & 255] ^ (((uint)Si[(r2 >> 8) & 255]) << 8) ^ (((uint)Si[(r1 >> 16) & 255]) << 16) ^ ((uint)Si[(r0 >> 24) & 255] << 24)) ^ kw[3];
            }
		...
		void DecryptBlock(byte[] input, int inOff, byte[] output, int outOff, uint[][] KW)
		{
			...
			{
				kw = KW[r--];
				r0 = Inv_Mcol((uint)Si[t0 & 255] ^ ((uint)Si[(r3 >> 8) & 255] << 8) ^ ((uint)Si[(t2 >> 16) & 255] << 16) ^ ((uint)Si[(t1 >> 24) & 255] << 24)) ^
				     kw[0];
				r1 = Inv_Mcol((uint)Si[t1 & 255] ^ ((uint)Si[(t0 >> 8) & 255] << 8) ^ ((uint)Si[(r3 >> 16) & 255] << 16) ^ ((uint)Si[(t2 >> 24) & 255] << 24)) ^
				     kw[1];
				r2 = Inv_Mcol((uint)Si[t2 & 255] ^ ((uint)Si[(t1 >> 8) & 255] << 8) ^ ((uint)Si[(t0 >> 16) & 255] << 16) ^ ((uint)Si[(r3 >> 24) & 255] << 24)) ^
				     kw[2];
				r3 = Inv_Mcol((uint)Si[r3 & 255] ^ ((uint)Si[(t2 >> 8) & 255] << 8) ^ ((uint)Si[(t1 >> 16) & 255] << 16) ^ ((uint)Si[(t0 >> 24) & 255] << 24)) ^
				     kw[3];
				kw = KW[r--];
				t0 = Inv_Mcol((uint)Si[r0 & 255] ^ ((uint)Si[(r3 >> 8) & 255] << 8) ^ ((uint)Si[(r2 >> 16) & 255] << 16) ^ ((uint)Si[(r1 >> 24) & 255] << 24)) ^
				     kw[0];
				t1 = Inv_Mcol((uint)Si[r1 & 255] ^ ((uint)Si[(r0 >> 8) & 255] << 8) ^ ((uint)Si[(r3 >> 16) & 255] << 16) ^ ((uint)Si[(r2 >> 24) & 255] << 24)) ^
				     kw[1];
				t2 = Inv_Mcol((uint)Si[r2 & 255] ^ ((uint)Si[(r1 >> 8) & 255] << 8) ^ ((uint)Si[(r0 >> 16) & 255] << 16) ^ ((uint)Si[(r3 >> 24) & 255] << 24)) ^
				     kw[2];
				r3 = Inv_Mcol((uint)Si[r3 & 255] ^ ((uint)Si[(r2 >> 8) & 255] << 8) ^ ((uint)Si[(r1 >> 16) & 255] << 16) ^ ((uint)Si[(r0 >> 24) & 255] << 24)) ^
				     kw[3];
			}
