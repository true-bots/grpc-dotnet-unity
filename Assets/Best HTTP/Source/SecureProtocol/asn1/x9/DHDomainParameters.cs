...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.X9
{
	public class DHDomainParameters
		: Asn1Encodable
	{
		readonly DerInteger p, g, q, j;
		readonly DHValidationParms validationParms;
		...
		DHDomainParameters(Asn1Sequence seq)
		{
		...
		static Asn1Encodable GetNext(IEnumerator<Asn1Encodable> e)
		{
