...
namespace BestHTTP.SecureProtocol.Org.BouncyCastle.Asn1.Crmf
{
		...
		: Asn1Encodable
	{
		...
		readonly AlgorithmIdentifier signingAlg;
		readonly X509Name issuer;
		readonly OptionalValidity validity;
		readonly X509Name subject;
		readonly SubjectPublicKeyInfo publicKey;
		readonly DerBitString issuerUID;
		readonly DerBitString subjectUID;
