...
namespace BestHTTP.Forms
{
	...
	public sealed class HTTPUrlEncodedForm : HTTPFormBase
	{
		...
		public override byte[] GetData()
		{
			...
			StringBuilder sb = StringBuilderPool.Get(Fields.Count * 4);
			...
			IsChanged = false;
			return CachedData = Encoding.UTF8.GetBytes(StringBuilderPool.ReleaseAndGrab(sb));
		}
